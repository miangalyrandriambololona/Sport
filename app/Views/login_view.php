...
<head>
    <meta charset="UTF-8">
    <title>FitSpace — Connexion</title>
    ...
    <div class="row justify-content-center">
        <div class="col-md-4">
            <div class="text-center mb-4">
                ...
                <p class="text-muted">Connectez-vous pour réserver</p>
            </div>
            <div class="card p-4">
                ...
                <form action="<?= site_url('login_action') ?>" method="post">
                    ...
                    <button type="submit" class="btn btn-main w-100 fw-bold">SE CONNECTER</button>
                </form>
                <div class="mt-4 text-center">
                    <span class="small">Nouveau ?</span> 
                    <a href="<?= site_url('register') ?>" class="small fw-bold text-decoration-none" style="color:var(--accent)">Créer un compte</a>
                </div>
            </div>
        </div>
    </div>
